  ...
  return (
    <div className="space-y-4 overflow-y-auto flex-grow">
      {files.map((file, index) => (
        <div
          key={index}
          className="grid grid-cols-12 gap-3 bg-background-light dark:bg-background-dark p-4 rounded-lg mb-4 "
        >
          <div className=" col-span-3">
            ...
            <p className="font-semibold mt-2 truncate text-text-light dark:text-text-dark">
              {file.file.name}
            </p>
