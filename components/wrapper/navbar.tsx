...
export default function NavBar() {
  ...
  return (
    <div className="w-full fixed right-0 left-0 border-b  shadow-sm z-10">
      <div className="container mx-auto">
        <div className="flex justify-between p-2  z-10 dark:bg-black dark:bg-opacity-50 bg-white">
          ...
          <div className="flex items-center gap-2 max-[825px]:hidden">
            {userId ? (
              ...
              <Link
                className="flex items-center space-x-2 border border-gray-200 rounded-md p-2 px-4"
                href="/sign-in"
              >
